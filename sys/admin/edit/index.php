...
<body>
    <div class="ct-edit">
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="cl-comp-desc">
                ...
                <textarea name="product_desc_edit"><?= $productDesc ?></textarea>
            </div>
    ...
    <?php
                ...
                if (isset($_POST["update_product"])) {
                    $pd_name_edit = $_POST["product_name_edit"];
                    $pd_price_edit = $_POST["product_price_edit"];
                    $pd_stock_edit = $_POST["product_stock_edit"];
                    $pd_weight_edit = $_POST["product_weight_edit"];
                    $pd_desc_edit = $_POST["product_desc_edit"];
                    $pd_category_edit = $_POST["product_category_edit"];
                    $pd_status_edit = $_POST["product_status_edit"];
